...
export default function FeaturesOverviewSection  () {
  ...
  return (
    <section className="flex items-center justify-between w-full py-16  max-[1500px]:px-[135px] px-[200px] gap-16 max-[1300px]:px-[100px] max-[1100px]:py-8 max-[1000px]:px-[50px] max-[680px]:px-[25px]  max-[1000px]:gap-8 max-[1000px]:flex-col max-[1000px]:items-start max-[1000px]:-mt-[30px] max-[767px]:-mt-[60px] max-[600px]:-mt-[100px]  max-[500px]:-mt-[50px]">
        ...
        <div className="flex flex-col items-start gap-8 max-[1300px]:gap-6">
          <div className="flex flex-col items-start gap-6 max-[767px]:gap-4">
            <div className="flex flex-col items-start gap-4 ">
              <Badge className="px-6 py-2 rounded-[20px]  bg-transparent border border-solid border-[#cdff08] shadow-[0px_0px_0px_1px_#ffffff1a] backdrop-blur-[5px] font-medium text-[#ccff09] leading-[120%] max-[1500px]:text-[16px] text-[18px] max-[767px]:text-[14px] max-[365px]:text-[12px] max-[767px]:leading-[100%] font-['Inter'] ">
                Feature
              </Badge>
