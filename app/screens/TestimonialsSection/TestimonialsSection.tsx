  ...
  return (
    <section className="flex flex-col items-center gap-14 max-[767px]:gap-8 py-16 max-[1500px]:px-[135px] px-[200px] w-full max-[1300px]:px-[100px] max-[1100px]:px-[50px] max-[767px]:px-[25px] max-[680px]:py-[32px]">
      ...
      <div className="flex flex-col items-center gap-11 w-full max-[1500px]:max-w-[1171px] w-[1371px]">
        ...
        <div
          ref={scrollRef}
          className={`flex items-stretch gap-0 w-full gap-[30px] max-[500px]:gap-[20px] overflow-x-auto scroll-smooth snap-x snap-mandatory px-0 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden`}
        >
          {testimonials.map((testimonial, index) => (
            <Card
              key={index}
              data-testimonial-card="true"
              className="max-[400px]:w-[300px] max-[350px]:w-[260px] w-[370px] min-w-[300px] max-[400px]:min-w-[300px] max-[350px]:min-w-[260px] max-[1100px]:w-[280px] max-[767px]:w-[calc(100%-50px)] max-[767px]:min-w-[calc(100%-50px)] last:mr-0 flex-shrink-0 snap-center flex flex-col items-start gap-8 px-[30px] py-[25px] bg-[#18181d] rounded-[30px] shadow-[12px_8px_36px_#0a1d0f0f]  max-[680px]:gap-4 max-[1100px]:px-[15px] max-[1100px]:py-[15px]"
            >
