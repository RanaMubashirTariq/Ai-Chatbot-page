  ...
  return (
    <section className="flex flex-col  gap-14 max-[767px]:gap-8 w-full items-center   px-[135px] py-[65px] max-[1300px]:px-[100px] max-[1300px]:py-[50px] max-[1000px]:px-[50px] max-[767px]:px-[25px] max-[1000px]:py-[40px]">
      <div className="flex flex-col items-center gap-4">
        <Badge className="px-6 py-[9px] max-[500px]:py-[5px] max-[500px]:px-[20px] rounded-[20px] border border-solid border-[#cdff08] shadow-[0px_0px_0px_1px_#ffffff1a] backdrop-blur-[5px] bg-transparent text-[#cdff09] font-medium-button max-[1500px]:text-base text-[18px] max-[767px]:text-[14px]">
          Feature
        </Badge>

        <h2 className="font-semibold text-[#ffffff]  max-[1500px]:text-[48px] text-[56px]  max-[1100px]:text-[36px] text-center leading-[120%] max-w-[597px] max-[767px]:text-[28px] max-[767px]:leading-[100%]">
          Dynamic Features of Our AI Chatbot
             ...
             <div className="flex items-center justify-between gap-[30px] w-full max-[500px]:flex-col max-[500px]:gap-5 ">
                   <div className="w-full max-[1500px]:max-w-[570px] w-[670px] h-auto">
