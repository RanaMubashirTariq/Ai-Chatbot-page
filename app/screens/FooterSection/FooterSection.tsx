...
export default function FooterSection  () {
  ...
  return (
    <footer className="flex flex-col items-center gap-16 max-[1000px]:gap-10 pt-20 max-[1000px]:pt-[60px] max-[767px]:pt-10 pb-0 px-[25px] bg-[#18181d] w-full max-[1300px]:px-[100px] max-[1000px]:px-[50px] max-[680px]:px-[25px] max-[550px]:gap-[20px] max-[550px]:pt-[32px]">
      <div className="flex flex-col w-full max-[1500px]:max-w-[1170px] max-w-[1520px] items-start gap-14 max-[1000px]:gap-10 max-[550px]:gap-[20px]">
          ...
          <div className="flex flex-col items-start gap-6 max-[767px]:gap-3">
            ...
            <div className="flex flex-col items-start gap-5">
              ...
              <div className="flex w-[270px] items-center gap-2 bg-[#ffffff1a] rounded-[1000px] p-1">
                <Input
                  className="flex-1 border-0 outline-none bg-transparent  focus-visible:ring-0 focus-visible:ring-offset-0 focus:shadow-none shadow-none text-[#a0a0ad] font-regular font-['Inter'] text-[18px] max-[1100px]:text-[16px] max-[767px]:text-[14px]  leading-[160%] placeholder:text-[#a0a0ad] focus-visible:ring-0 focus-visible:ring-offset-0 focus:shadow-none shadow-none  max-[550px]:text-[14px] max-[550px]:leading-[120%]"
                  placeholder="Enter your email"
                />
                <Button
                  size="icon"
                  className="bg-[#cdff09] hover:bg-[#cdff09]/90 rounded-full h-10 w-10 max-[500px]:mr-[10px] p-0 max-[550px]:h-[28px] max-[550px]:w-[28px] cursor-pointer transform transition-transform duration-300 hover:scale-90 "
                >
      ...
      <div className="flex flex-col items-center gap-10 pt-0 pb-[60px] max-[767px]:pb-10  px-[135px] w-full max-[1100px]:px-[100px] max-[1000px]:px-[50px] max-[680px]:px-[25px] max-[767px]:gap-[20px] max-[767px]:pb-[32px]">
        <p className="text-[#ebebeb] font-['Inter'] text-center font-medium text-[18px] max-[1100px]:text-[16px] max-[1000px]:text-[16px] leading-[160%] max-[767px]:text-[14px] max-[500px]:text-[13px] max-[1000px]:leading-[130%]">
